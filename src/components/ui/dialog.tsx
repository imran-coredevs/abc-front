            ...
            >
                ...
                {showCloseButton && (
                    <DialogPrimitive.Close
                        ...
                        className="data-[state=open]:bg-white-50 absolute top-4 right-4 cursor-pointer rounded-xs transition-opacity hover:opacity-100 focus:outline-hidden active:ring-2 disabled:pointer-events-none data-[state=open]:text-neutral-800 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-6"
                    >
                        <XIcon />
...
function DialogHeader({ className, ...props }: React.ComponentProps<'h3'>) {
    return (
        <div
...
function DialogDescription({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Description>) {
    return (
        <DialogPrimitive.Description
            ...
            className={cn('p-md text-neutral-800', className)}
            {...props}
        />
    )
}
