        ...
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                className={cn(
                    ...
                    {
                        'inset-x-0 top-0 border-b border-neutral-700 data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top':
                            side === 'top',
                        ...
                        'inset-x-0 bottom-0 border-t border-neutral-700 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom':
                            side === 'bottom',
                        'inset-y-0 left-0 h-full w-3/4 border-r border-neutral-700 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm':
                            side === 'left',
                    },
                    className,
                )}
            ...
            >
                ...
                <SheetPrimitive.Close className="absolute top-4 right-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
                    <XIcon className="size-5 text-neutral-300" />
