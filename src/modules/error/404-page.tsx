    ...
    return (
        <div className="flex h-screen items-center justify-center bg-neutral-950 text-neutral-50">
            <div className="text-center">
                <h1 className="text-blue-500 text-6xl font-bold">404</h1>
                ...
                <a
                    href="/"
                    className="bg-blue-500 hover:bg-blue-600 mt-6 inline-block rounded-md px-6 py-3 text-neutral-950 transition-colors"
                >
                    Go to Homepage
                </a>
            </div>
