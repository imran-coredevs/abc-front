...
export const STRATEGY_FORM_DEFAULTS: StrategyFormData = {
    ...
    indicators: {
        rsi: { role: 'signal', period: 14, overboughtLevel: 70, oversoldLevel: 30, source: 'close', smoothingType: 'None', smoothingLength: 14, bbMultiplier: 2 },
        utBot: { role: 'signal', atrPeriod: 10, atrMultiplier: 1, signalLookbackBars: 5, useHeikinAshi: false },
        superTrend: { role: 'disabled', atrPeriod: 10, atrMultiplier: 3, srcPrice: 'hl2'},
        hullSuite: { role: 'disabled', length: 55, lengthMultiplier: 1, mode: 'Hma' },
